...
### Главная страница
<img src="screenshots/main.jpg" alt="Процесс игры" width="500">
...
-Управление валютами: просмотр списка валют и добавление новых валют с уникальными кодами<br>
-Управление обменными курсами: просмотр, добавление и обновление курсов валютных пар<br>
-Конвертация валют: расчет перевода сумм между валютами с поддержкой прямых, обратных и кросс-курсов (через USD)<br>
-REST API с корректной обработкой HTTP-кодов и ошибок<br>
