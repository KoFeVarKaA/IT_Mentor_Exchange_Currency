...
-Управление валютами: просмотр списка валют и добавление новых валют с уникальными кодами
-Управление обменными курсами: просмотр, добавление и обновление курсов валютных пар
-Конвертация валют: расчет перевода сумм между валютами с поддержкой прямых, обратных и кросс-курсов (через USD)
-REST API с корректной обработкой HTTP-кодов и ошибок
