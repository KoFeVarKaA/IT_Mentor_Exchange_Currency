...
```
Теперь можно либо напрямую взаимодействовать с api через запробы по адресу http://127.0.0.1:8888/,
либо через сайт, который находится по адресу frontend/index.html
